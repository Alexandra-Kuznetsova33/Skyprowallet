...
import { Row, Cell, DeleteIcon } from './ExpenseItem.styled';
...
export default function ExpenseItem({ expense }) {
  ...
  return (
    ...
    >
      <Cell width='141px'>{expense.description}</Cell>
      <Cell width='141px'>{category?.label || ''}</Cell>
      <Cell width='142px'>{formatDate(expense.date)}</Cell>
      <Cell width='158px'>{expense.amount} ₽</Cell>
      <Cell width='12px'>
        <DeleteIcon
          $isHovered={isHovered}
